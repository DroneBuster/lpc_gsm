 ...
 */
#define VAL_GPIO1DIR            PAL_PORT_BIT(GPIO1_LED1_Y) | \
                                PAL_PORT_BIT(GPIO1_LED2_Y)
#define VAL_GPIO1DATA           0x00000000

/*
 * GPIO 2 initial setup.
 */
#define VAL_GPIO2DIR            PAL_PORT_BIT(GPIO2_RES_LEA)
 ...
 * Pin definitions.
 */
#define GPIO1_LED1_Y          28
#define GPIO1_LED2_Y          29

#define GPIO2_RES_LEA          7
